                ...
                <div class="col-md-8">
                    <div class="produk-list">
                        ...
                        <div class="produk-item d-flex">
                            <img src="{{ asset('$jenisCokelat->foto')}}" alt="Cokelat Box" class="produk-img">
                            <div class="produk-info">
                                <h5>{{ $jenisCokelat->nama }}</h5>
                                <p>Rp {{ number_format($jenisCokelat->harga, 0, ',', '.') }}</p>
                            </div>
                        </div>
                        @endif
                        @foreach ($karakterCokelat as $karakter)
                        <div class="produk-item d-flex">
                            <img src="{{ asset('$karakter->foto')}}" alt="{{ $karakter->nama }}" class="produk-img">
                            <div class="produk-info">
                                <h5>{{ $karakter->nama }}</h5>
                                <p>{{ $selectedKarakter[$karakter->id]['jumlah'] }}</p>
                                <p class="catatan">{{ $selectedKarakter[$karakter->id]['catatan'] }}</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    <form action="{{ route('finalize_pesanan') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="input-data">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" value="Evelyn">
                                <label for="email" class="mt-2">Email</label>
                                <input type="email" class="form-control" id="email" name="email" value="evelyn@gmail.com">
                                <label for="noHp" class="mt-2">No Hp</label>
                                <input type="text" class="form-control" id="noHp" name="noHp" value="081287430731">
                                <label for="tanggalPengiriman" class="mt-2">Tanggal Pengiriman</label>
                                <input type="date" class="form-control" id="tanggalPengiriman" name="tanggalPengiriman" value="2016-01-13">
                                <label for="alamatLengkap" class="mt-2">Alamat Lengkap</label>
                                <input type="text" class="form-control" id="alamatLengkap" name="alamatLengkap" value="Jl Abadi no 8">
                                <label for="kecamatan" class="mt-2">Kecamatan</label>
                                <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="Cidadap">
                                <label for="kota" class="mt-2">Kota/Kabupaten</label>
                                <input type="text" class="form-control" id="kota" name="kota" value="Bandung">
                                ...
                                <label for="kodePos" class="mt-2">Kode Pos</label>
                                <input type="text" class="form-control" id="kodePos" name="kodePos" value="40217">
                            </div>
                        </div>
                        <div class="form-group mt-3">
                ...
                <div class="col-md-4">
                    <div class="rekap-pilihan">
                        ...
                        <div class="jenis-pilihan">
                            <p class="text">{{ $jenisCokelat ? $jenisCokelat->nama : 'Tidak ada produk' }}</p>
                        ...
                        <div class="total-harga">
                            ...
                            <p class="harga">Rp {{ number_format($deliveryCost, 0, ',', '.') }}</p>
                        </div>
                        <hr>
