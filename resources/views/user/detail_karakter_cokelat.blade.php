...
@section('title', 'Detail Karakter - ' . $cokelat->nama)
                    ...
                    <div class="col-md-3 produk-card">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <a class="btn button-detail" href="{{ route('user.detail_karakter_cokelat.show', $relatedCokelat->id) }}" role="button">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
