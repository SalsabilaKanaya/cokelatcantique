...
<head>
    ...
    <title>List Jenis Cokelat - Cokelat Cantique</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/jenis_cokelat.css') }}">
</head>
<body>
    ...
    <section class="home-section">
        ...
        <div class="content">
            ...
            <div class="box">
                ...
                {{ $jenisCokelat->links('vendor.pagination.default') }}
            </div>
        </div>
    </section>

    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="{{ asset('js/admin/jenis_cokelat.js') }}"></script>
