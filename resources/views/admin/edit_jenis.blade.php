...
<head>
    ...
    <title>Edit Jenis {{ $jenis->nama }} - Cokelat Cantique</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_jenis.css') }}">
</head>
<body>
                ...
                <form id="edit-jenis-form" action="{{ route('admin.edit_jenis.update', $jenis->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="nama" id="nama" value="{{ $jenis->nama }}" placeholder="Masukkan Nama" required>
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" name="harga" id="harga" value="{{ $jenis->harga }}" placeholder="Masukkan Harga" required>
                        </div>
                        <div class="col">
                            <label for="jumlah_karakter" class="form-label">Jumlah Karakter</label>
                            <input type="number" class="form-control" name="jumlah_karakter" id="jumlah_karakter" value="{{ $jenis->jumlah_karakter}}" placeholder="Masukkan jumlah karakter minimal" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" id="deskripsi" rows="3" placeholder="Masukkan Deskripsi" required>{{ $jenis->deskripsi }}</textarea>
                    </div>
