...
<head>
    ...
    <title>Kustomisasi Cokelat (Cokelat Cantique)</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/kustomisasi_cokelat.css')}}">
</head>
<body>
    <!--Navbar-->
                ...
                <div class="col-12">
                    <div class="navbar-nav justify-content-center">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('kustomisasi_cokelat')}}">Kustomisasi Cokelat</a>
                            </li>
                            <li class="nav-item">
